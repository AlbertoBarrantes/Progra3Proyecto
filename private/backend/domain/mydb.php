...
class User extends BaseDomain implements \JsonSerializable{
    ...
    public static function createUser($id, $user_name, $login_name, $user_last_name1, $user_last_name2, $user_email, $user_password, $address, $user_work_phone, $user_home_phone) {
        $instance = new self();
        $instance->id                   = $id;
